...
import { SpacerComponent } from '@/types/page-builder'
import { cn } from '@/lib/utils'

interface SpacerRendererProps {
  component: SpacerComponent
  isEditing?: boolean
  onEdit?: (component: SpacerComponent) => void
  className?: string
}
  ...
  return (
    <div
      className={cn(
        'w-full',
        responsiveClasses,
        isEditing && 'cursor-pointer hover:bg-gray-50 hover:outline hover:outline-2 hover:outline-blue-500 hover:outline-offset-2 relative'
      )}
